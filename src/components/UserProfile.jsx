...
const activeBtnStyles =
  "w-20 bg-red-500 text-white font-bold p-2 rounded-full outline-none";
const inactiveBtnStyles =
  "w-20 bg-primary text-black font-bold p-2 rounded-full outline-none";
